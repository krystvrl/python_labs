...
![json to csv](images/lab05/suscontocsv.jpg)
![csv to json](images/lab05/suscontojson.jpg)

Ошибка при отсутствия файла
![filenotfound](images/lab05/filenotfound.jpg)

Ошибка при неправильном входном/выходном файле
![valueerror](images/lab05/valueerror..jpg)
### Задание B
``` python
from pathlib import Path
import csv
...
![xlsx](images/lab05/csvtoxlsx.jpg)