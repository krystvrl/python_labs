...
class ndenumerate(Generic[_ScalarT_co]):
    @overload
    def __new__(
        cls, arr: _FiniteNestedSequence[_SupportsArray[np.dtype[_ScalarT]]]
    ) -> ndenumerate[_ScalarT]: ...
    @overload
    ...
    ) -> ndenumerate[np.float64]: ...
    @overload
    def __new__(
        cls, arr: complex | _NestedSequence[complex]
    ) -> ndenumerate[np.complex128]: ...
    @overload
    ...
    def __next__(
        self: ndenumerate[
            np.bool | np.number | np.flexible | np.datetime64 | np.timedelta64
        ],
        /,
...
class nd_grid(Generic[_BoolT_co]):
    ...
    @overload
    def __getitem__(
        self: nd_grid[L[False]], key: slice | Sequence[slice]
    ) -> NDArray[Incomplete]: ...
    @overload
    def __getitem__(
        self: nd_grid[L[True]], key: slice | Sequence[slice]
    ) -> tuple[NDArray[Incomplete], ...]: ...
...
class AxisConcatenator(Generic[_AxisT_co, _MatrixT_co, _NDMinT_co, _Trans1DT_co]):
    ...
    @overload
    def concatenate(
        *a: ArrayLike, axis: SupportsIndex | None = 0, out: _ArrayT
    ) -> _ArrayT: ...
    @staticmethod
    @overload
    def concatenate(
        *a: ArrayLike, axis: SupportsIndex | None = 0, out: None = None
    ) -> NDArray[Incomplete]: ...
...
@overload
def ix_(
    *args: _FiniteNestedSequence[_SupportsDType[_DTypeT]],
) -> tuple[np.ndarray[_AnyShape, _DTypeT], ...]: ...
@overload
