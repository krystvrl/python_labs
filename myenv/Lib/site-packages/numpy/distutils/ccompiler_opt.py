...
class _Config:
    ...
    conf_features = dict(
        ...
        ## Power10/ISA 3.1
        VSX4=dict(
            interest=4, implies="VSX3", implies_detect=False, extra_checks="VSX4_MMA"
        ),
        # IBM/Z
        ## VX(z13) support
    ...
    def conf_features_partial(self):
        ...
        if on_x86 and self.cc_is_msvc:
            return dict(
                ...
                AVX512_CNL={},
                AVX512_ICL={},
                AVX512_SPR=dict(disable="MSVC compiler doesn't support it"),
            )
...
class _CCompiler:
    ...
    def __init__(self):
        ...
        detect_args = (
            ...
            ("cc_has_native", ".*(-march=native|-xHost|/QxHost|-mcpu=a64fx).*", ""),
